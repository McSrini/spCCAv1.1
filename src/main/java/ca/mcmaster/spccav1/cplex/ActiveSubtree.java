 ...
 */
package ca.mcmaster.spccav1.cplex;

import static ca.mcmaster.spccav1.Main.ZERO;
import ca.mcmaster.spccav1.UtilityLibrary;
import ca.mcmaster.spccav1.cca.IndexNode;
import ca.mcmaster.spccav1.cca.IndexTree;
import ca.mcmaster.spccav1.cplex.datatypes.NodeAttachment;
import ca.mcmaster.spccav1.cplex.handlers.*;
import ilog.concert.IloException;
import ilog.cplex.IloCplex;
import java.util.ArrayList;
import java.util.List;
import java.util.Map;
import static ca.mcmaster.spccav1.Main.BILLION;
...
public class ActiveSubtree {
    ...
    public double getBestObjValue(){
        return this.branchHandler.bestObjValue;
    }
    ...
    public void solveFor2Min() throws IloException{
       //cplex.setParam( IloCplex.Param.MIP.Strategy.Backtrack,  ZERO); 
        cplex.setParam(IloCplex.Param.TimeLimit, 2*60); 
        cplex.solve();
