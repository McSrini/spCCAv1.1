 ...
 */
package ca.mcmaster.spccav1;

import ca.mcmaster.spccav1.cca.IndexNode;
import ca.mcmaster.spccav1.cplex.ActiveSubtree;
...
public class Main {
    ...
    public static   int NUM_LEAFS_FOR_MIGRATION_IN_CCA_SUBTREE  =  5;
    
    //for testing, grow the tree this big
    public static final int TOTAL_LEAFS_IN_SOLUTION_TREE =  40 ;
    */
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (! isHaltFilePresent()){
            ...
            if (activeSubtreeNew.isUnfeasible()){
